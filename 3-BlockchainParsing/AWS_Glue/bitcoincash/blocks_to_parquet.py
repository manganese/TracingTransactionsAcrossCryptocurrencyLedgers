...
## @return: data_source
## @inputs: []
data_source = glueContext.create_dynamic_frame.from_catalog(database="bitcoincash", table_name="blocks_0_564434_csv",
...
mapped_frame = ApplyMapping.apply(frame=data_source, mappings=[
    ("col0", "string", "blockhash", "string"),
    ("col1", "long", "height", "long"),
    ("col2", "long", "col2", "long"),
    ("col3", "long", "col3", "long"),
...
data_sink = glueContext.write_dynamic_frame.from_options(frame=drop_null_fields_frame,
                                                         connection_type="s3",
                                                         connection_options={
                                                             "path": "s3://ethereumxxx/bch/blocks"},
