...
## @return: data_source
## @inputs: []
data_source = glueContext.create_dynamic_frame.from_catalog(database="bitcoincash", table_name="tx_in_0_564434_csv",
...
mapped_frame = ApplyMapping.apply(frame=data_source, mappings=[
    ...
    ("col1", "string", "hashprevout", "string"),
    ("col2", "long", "indexprevout", "long"),
