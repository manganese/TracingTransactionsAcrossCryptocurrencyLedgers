...
## @return: data_source
## @inputs: []
data_source = glueContext.create_dynamic_frame.from_catalog(database="bitcoincash", table_name="tx_out_0_564434_csv",
...
mapped_frame = ApplyMapping.apply(frame=data_source, mappings=[
    ...
    ("col1", "long",   "indexout", "long"),
    ("col2", "long",   "value", "long"),
    ("col3", "string", "col3", "string"),
    ("col4", "string", "address", "string")],
