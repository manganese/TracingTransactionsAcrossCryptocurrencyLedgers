...
## @return: data_source
## @inputs: []
data_source = glueContext.create_dynamic_frame.from_catalog(database="litecoin", table_name="vin_csv",
...
mapped_frame = ApplyMapping.apply(frame=data_source, mappings=[
    ...
    ("vout", "long", "vout", "long"),
    ("prev_txid", "string", "prev_txid", "string"),
...
data_sink = glueContext.write_dynamic_frame.from_options(frame=drop_null_fields_frame,
                                                         connection_type="s3",
                                                         connection_options={
                                                             "path": "s3://aws-glue-litecoin/litecoin/vin"},
